 ...
 */
public class AppID extends AbstractTable {

    public static final String TABLE_NAME = "APPID";

    public AppID(Lexer lex, Tables.Callback cb) throws IOException {
        super(lex, cb);
    }

    protected boolean handleRecord(Tables.Callback cb, Entity rec) {
        return cb.handleAppID(rec);
    }
}
