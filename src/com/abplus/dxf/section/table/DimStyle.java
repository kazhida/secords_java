 ...
 */
public class DimStyle extends AbstractTable {

    public static final String TABLE_NAME = "DIMSTYLE";

    public DimStyle(Lexer lex, Tables.Callback cb) throws IOException {
        super(lex, cb);
    }

    protected boolean handleRecord(Tables.Callback cb, Entity rec) {
        return cb.handleDimStyle(rec);
    }
}